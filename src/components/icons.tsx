...
export type IconProps = { size?: number; color?: string; style?: CSSProps };

export function TrophyIcon({ size=18, color="currentColor", style={} }: IconProps) {
  return (
...
export function CardIcon({ size=18, color="currentColor", style={} }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" style={style}>
...
export function ClipboardIcon({ size=18, color="currentColor", style={} }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" style={style}>
...
export function CoinsIcon({ size=18, color="currentColor", style={} }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" style={style}>
...
export function XCircleIcon({ size=22, color="currentColor", style={} }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" style={style}>
      <circle cx="12" cy="12" r="10"/>
...
export function SpinIcon({ size=18, color="currentColor", style={} }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" style={style}>
...
export function PencilIcon({ size=14, color="currentColor", style={} }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" style={style}>
...
export function CrownIcon({ size=18, color="currentColor", style={} }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" style={style}>
...
export function MedalIcon({ rank, size=22, style={} }: { rank: number; size?: number; style?: CSSProps }) {
